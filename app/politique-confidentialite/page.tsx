        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="bg-[#FFB23F]/10 rounded-2xl p-6 text-center">
              ...
              <p className="text-sm text-[#778DA9]">
                Chiffrement SSL 256 bits et hébergement sécurisé en France
              </p>
            </div>
            <div className="bg-[#FFB23F]/10 rounded-2xl p-6 text-center">
              ...
              <p className="text-sm text-[#778DA9]">
                Accès, rectification, suppression : vous gardez le contrôle
              </p>
            </div>
          </div>
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            ...
            <div className="bg-[#1B263B] text-white rounded-2xl p-8">
              ...
              <p className="text-white/90">
                Chez GetFlaire, la protection de vos données personnelles est une priorité absolue.
                Cette politique de confidentialité vous explique de manière transparente comment nous
                collectons, utilisons et protégeons vos informations personnelles dans le respect du
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <div className="text-[#778DA9] space-y-4">
                ...
                <div className="bg-white rounded-xl p-6 border-l-4 border-[#FFB23F]">
                  <p>
                    <strong className="text-[#1B263B]">GetFlaire</strong>
                    <br />
                    11 rue de la Fontaine Nagot, 10120 Saint-André-les-Vergers
                    <br />
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-white rounded-xl p-6">
                    ...
                    <ul className="list-disc list-inside space-y-2 text-sm">
                      ...
                      <li>Gestion des notes liées à vos recherches</li>
                    </ul>
                  </div>
              ...
              <div className="text-[#778DA9] space-y-4">
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white rounded-xl p-6 border-l-4 border-purple-500">
                    ...
                    <p className="text-sm">Communications marketing (révocable à tout moment)</p>
                  </div>
              ...
              <div className="text-[#778DA9] space-y-4">
                ...
                <div className="space-y-4">
                  <div className="bg-white rounded-xl p-6">
                    ...
                    <ul className="list-disc list-inside space-y-2 text-sm">
                      <li>Hébergeur (données hébergées en France)</li>
                  ...
                  <div className="bg-white rounded-xl p-6">
                    ...
                    <p className="text-sm">Autorités compétentes en cas de demande légale ou judiciaire</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white/10 rounded-xl p-6 mt-6">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <p>
                      <strong>Courrier :</strong> GetFlaire, 11 rue de la Fontaine Nagot, 10120 Saint-André-les-Vergers
                    </p>
                  </div>
              ...
              <div className="text-[#778DA9] space-y-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white rounded-xl p-6">
                    ...
                    <p className="text-sm">
                      Nous aident à comprendre l&apos;utilisation du site (avec votre consentement)
                    </p>
                  </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <div className="text-[#778DA9] space-y-4">
                <p>
                  ...
                  services ou de la réglementation. Toute modification importante vous sera notifiée par email
                  et/ou via la plateforme.
                </p>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <div className="space-y-2 text-sm text-white/90">
                        ...
                        <p>
                          <strong>Adresse :</strong> 11 rue de la Fontaine Nagot, 10120 Saint-André-les-Vergers
                        </p>
                      </div>
                    </div>
