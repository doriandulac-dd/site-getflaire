            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <div className="text-[#778DA9] space-y-6">
                <div>
                  ...
                  <p className="mb-2"><strong className="text-[#1B263B]">Données :</strong> Nom, prénom, email, entreprise, critères de recherche, historique d&apos;utilisation</p>
                  <p className="mb-2"><strong className="text-[#1B263B]">Finalité :</strong> Fourniture du service de surveillance immobilière, alertes personnalisées, CRM</p>
                  <p><strong className="text-[#1B263B]">Base légale :</strong> Exécution du contrat</p>
                </div>

                <div>
                  <h3 className="text-lg font-semibold text-[#1B263B] mb-3">Facturation et paiement</h3>
                  <p className="mb-2"><strong className="text-[#1B263B]">Données :</strong> Informations de facturation, historique des paiements</p>
                  <p className="mb-2"><strong className="text-[#1B263B]">Finalité :</strong> Gestion des abonnements, facturation, comptabilité</p>
                  <p><strong className="text-[#1B263B]">Base légale :</strong> Exécution du contrat et obligations légales</p>
                </div>

                <div>
                  <h3 className="text-lg font-semibold text-[#1B263B] mb-3">Support client</h3>
                  <p className="mb-2"><strong className="text-[#1B263B]">Données :</strong> Échanges emails, logs de connexion, données techniques</p>
                  <p className="mb-2"><strong className="text-[#1B263B]">Finalité :</strong> Assistance technique, résolution de problèmes</p>
                  <p><strong className="text-[#1B263B]">Base légale :</strong> Intérêt légitime</p>
                </div>

                <div>
                  <h3 className="text-lg font-semibold text-[#1B263B] mb-3">Sécurité et amélioration</h3>
                  <p className="mb-2"><strong className="text-[#1B263B]">Données :</strong> Logs de connexion, adresses IP, données d&apos;usage anonymisées</p>
                  <p className="mb-2"><strong className="text-[#1B263B]">Finalité :</strong> Sécurité, prévention de la fraude, amélioration du service</p>
                  <p><strong className="text-[#1B263B]">Base légale :</strong> Intérêt légitime</p>
                </div>

                <div>
                  <h3 className="text-lg font-semibold text-[#1B263B] mb-3">Communications marketing</h3>
                  <p className="mb-2"><strong className="text-[#1B263B]">Données :</strong> Email, préférences de communication</p>
                  <p className="mb-2"><strong className="text-[#1B263B]">Finalité :</strong> Newsletter, informations produit, offres commerciales</p>
                  <p><strong className="text-[#1B263B]">Base légale :</strong> Consentement (révocable à tout moment)</p>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-4">
                  <div className="bg-white rounded-xl p-6">
                    ...
                    <ul className="list-disc list-inside space-y-2 text-sm">
                      <li><strong>Hébergeur :</strong> Données hébergées en France avec garanties de sécurité</li>
                      <li><strong>Service d&apos;emailing :</strong> Pour l&apos;envoi des alertes et communications</li>
                      <li><strong>Support client :</strong> Outils de gestion des tickets et assistance</li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-white rounded-xl p-6">
                    ...
                    <p className="text-sm">
                      Si des transferts hors UE sont nécessaires, ils sont encadrés par des clauses contractuelles types 
                      ou des décisions d&apos;adéquation de la Commission européenne.
                    </p>
                  </div>
                </div>
              </div>
